\chapter{Usage}
\hypertarget{md_2__usage}{}\label{md_2__usage}\index{Usage@{Usage}}
\label{md_2__usage_autotoc_md8}%
\Hypertarget{md_2__usage_autotoc_md8}%
\hypertarget{md_2__usage_autotoc_md9}{}\doxysection{\texorpdfstring{Running locally (not needed)}{Running locally (not needed)}}\label{md_2__usage_autotoc_md9}
\hypertarget{md_2__usage_autotoc_md10}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{md_2__usage_autotoc_md10}
...
\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md11}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{md_2__usage_autotoc_md11}
From the build folder, you can run the tests. 
\begin{DoxyCode}{0}
\DoxyCodeLine{./tests/vkdb\_tests}

\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md12}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{md_2__usage_autotoc_md12}
From the build folder, you can also run any of the examples. 
\begin{DoxyCode}{0}
\DoxyCodeLine{./examples/<filename>}

\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md13}{}\doxysection{\texorpdfstring{Using the library}{Using the library}}\label{md_2__usage_autotoc_md13}
\hypertarget{md_2__usage_autotoc_md14}{}\doxysubsection{\texorpdfstring{Setup}{Setup}}\label{md_2__usage_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md15}{}\doxysubsection{\texorpdfstring{Interface}{Interface}}\label{md_2__usage_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md16}{}\doxysubsection{\texorpdfstring{Table management}{Table management}}\label{md_2__usage_autotoc_md16}
...
\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md17}{}\doxysubsection{\texorpdfstring{General queries}{General queries}}\label{md_2__usage_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{md_2__usage_autotoc_md18}{}\doxysubsection{\texorpdfstring{Playground}{Playground}}\label{md_2__usage_autotoc_md18}
...
This is generally for experimental purposes—there\textquotesingle{}s not much to gain from it in practice besides having a playground.\hypertarget{md_2__usage_autotoc_md19}{}\doxysubsection{\texorpdfstring{Mock data}{Mock data}}\label{md_2__usage_autotoc_md19}
