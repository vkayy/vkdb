...
void VQ::runFile(const std::filesystem::path path) {
...
void VQ::run(const std::string& source) {
  Lexer lexer{source};
...
void VQ::error(Token token, const std::string& message) {
...
void VQ::runtimeError(const RuntimeError& error) {
